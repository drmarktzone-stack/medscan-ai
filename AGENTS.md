...
ד"ר סמר מוסיף משימות כקובצי פרומפט (`.md`) בתיקייה `prompts/inbox/`. **כשהמשתמש כותב בצ'אט טריגר כמו "בדוק את ה-inbox" / "הרץ את הפרומפטים החדשים" (או `/inbox` ב-Claude Code):**
