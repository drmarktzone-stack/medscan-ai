...
import ChatBubble from '@/wechat/components/ChatBubble.jsx';
import {
  useWeChat,
  getChatTitle,
  getChatAvatar,
  ...
  if (!chat) {
    return (
      <div className="p-8 text-center text-[#b2b2b2]">
        <p>צ\'אט לא נמצא</p>
        <Link to="/wechat" className="text-[#576b95] text-sm mt-2 inline-block">
          חזרה
        </Link>
      </div>
    );
    ...
    <div className="min-h-screen bg-[#ededed] flex flex-col max-w-lg mx-auto">
      <header className="sticky top-0 z-40 bg-[#ededed] border-b border-[#d9d9d9]">
        <div className="flex items-center h-11 px-2">
          <Link to="/wechat" className="text-[#576b95] text-sm px-2">
            ‹ חזרה
          </Link>
