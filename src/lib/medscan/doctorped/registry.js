...
export const MEDSCAN_MODULES = Object.freeze([
  ...
  Object.freeze({
    id: 'audio', route: '/doctorped', engine: 'audio',
  ...
  Object.freeze({
    id: 'milestones', route: '/doctorped', engine: 'infantNutritionAndDevelopment',
