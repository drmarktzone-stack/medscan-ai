...
export const SEED_RANGES = [
  ...
  { analyte: 'cholesterol_total', label_he: 'כולסטרול כללי', unit: 'mg/dL', bands: [b(731, OPEN, null, 170)] },
  { analyte: 'ldl', label_he: 'LDL', unit: 'mg/dL', bands: [b(731, OPEN, null, 110)] },
  { analyte: 'hdl', label_he: 'HDL', unit: 'mg/dL', bands: [b(731, OPEN, 45, null)] },
  {
