/**
 * BizBoost AI — ממצאי מחקר על עסקים ואתרים בישראל (2026)
 * מקורות: nwmedia.co.il, pinklime.io, localseoisrael.co.il, shebossit.com
 */
...
export const COMMON_PROBLEMS = [
  ...
  },
  {
    ...
    painPoints: [
      'פרסום ספורadic ברשתות בלי לוח שנה',
...
export const TARGET_BUSINESSES = [
  {
    name: 'New Way Media',
    url: 'https://nwmedia.co.il',
    industry: 'שיווק דיגיטלי',
    strengths: ['WhatsApp CTA', 'תוכן עברי עשיר', 'Social proof'],
    gaps: ['טופס הרשמה ארוך', 'מעקב לידים לא אוטומטי'],
    recommendedTool: 'LeadBot',
    outreachAngle: 'אתם כבר מביאים לידים — LeadBot יענה תוך 30 שניות גם בלילה',
  },
  {
    name: 'PinkLime',
    url: 'https://pinklime.io',
    industry: 'פיתוח מוצרים דיגיטליים',
    strengths: ['עיצוב מקצועי', 'מוצר AI קיים (LemonAid)', 'דו-לשוני'],
    gaps: ['CTA כללי "Get in Touch"', 'פחות תוכן SEO בעברית'],
    recommendedTool: 'ContentFlow',
    outreachAngle: 'ContentFlow ייצר תוכן עברי שמדגיש את LemonAid לקהל המקומי',
  },
  {
    name: 'Local SEO Israel',
    url: 'https://localseoisrael.co.il',
    industry: 'SEO מקומי',
    strengths: ['מומחיות SEO', 'תוכן מעמיק'],
    gaps: ['ConvertScan כ-upsell ללקוחות', 'LeadBot לטפסים'],
    recommendedTool: 'ConvertScan',
    outreachAngle: 'ConvertScan כ-white-label — תציעו ביקורת המרה לכל לקוח SEO',
  },
  {
    name: 'Shebossit',
    url: 'https://shebossit.com',
    industry: 'Lead gen B2B',
    strengths: ['מיקוד לידים', 'תוכן אסטרטגי'],
    gaps: ['מעקב אחרי טופס', 'תוכן דו-לשוני לנישות'],
    recommendedTool: 'LeadBot + ContentFlow',
    outreachAngle: 'חבילת BizBoost — מענה מיידי + תוכן לדפי נחיתה',
  },
];
