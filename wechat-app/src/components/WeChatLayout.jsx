...
const TABS = [
  { to: '/', label: '微信', labelHe: 'צ\'אטים', icon: MessageCircle, end: true },
  { to: '/contacts', label: '通讯录', labelHe: 'אנשי קשר', icon: Users, end: true },
  { to: '/discover', label: '发现', labelHe: 'גילוי', icon: Compass, end: true },
  { to: '/me', label: '我', labelHe: 'אני', icon: User, end: true },
];
    ...
    <header className="sticky top-0 z-40 bg-[#ededed] border-b border-[#d9d9d9]">
      <div className="max-w-lg mx-auto flex items-center justify-between h-11 px-4">
        <div className="flex items-center gap-2 min-w-0">
          <h1 className="font-semibold text-[17px] text-[#191919]">WeiChat 微聊</h1>
          <SyncBadge />
        </div>
        <button
          type="button"
